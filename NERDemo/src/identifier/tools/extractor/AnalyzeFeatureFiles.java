...
import identifier.tools.utils.ParseTree;
...
//		for (File xmlfile : xmlfiles) {
		File xmlfile = new File(txtPath);
			...
			Document StanfordDoc = builder.parse(StanfordInputpath);
...
//					}
			...
			if(type == 'e'){
				String filename =  outputPath + "/" + txtName + "_temp.xml";
